    package com.example.a7s21_ddim_proyectofinal3_qacj;
    ...
    public class PrincipalActivity extends AppCompatActivity implements OnMapReadyCallback {
        ...
        private static final String URL_SHEET = "https://script.google.com/macros/s/AKfycbwHrRBlqsPAxygTQWdrA2r9rCGpQyxHzbOGTvomhd_QLmCUy2uS_ugCoj3qcn2JZrRU/exec";

        private LocationRequest locationRequest;
        private Button OBUBICACION;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            OBUBICACION = findViewById(R.id.OBUBICACION);
            ...
            OBUBICACION.setOnClickListener(v -> checkLocationPermission());
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                Toast.makeText(PrincipalActivity.this, "UBICACION CAPTURADA " + message, Toast.LENGTH_SHORT).show();
                ...
                if (wifiManager != null) {
                    ...
                    if (wifiInfo != null) {
                        ...
                        if (macAddress != null && !macAddress.equals("02:00:00:00:00:00")) {
                            ...
                            return "NO ES POSIBLE OBTENERLA";
                        }
                    }
                }
            } catch (Exception e) {
        ...
        public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
            ...
            if (requestCode == LOCATION_PERMISSION_REQUEST_CODE) {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(this, "NO SE PUEDE OBTENER UBICACION", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }